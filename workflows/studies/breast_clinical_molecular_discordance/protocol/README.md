...
`../reviews/RESEARCH_COMPLETION_AUDIT_v1.11.0.yaml` with a human-readable
`RESEARCH_COMPLETION_REPORT_v1.11.0.md`. Earlier versions remain immutable
...
uv run nas-core study completion-validate \
  workflows/studies/breast_clinical_molecular_discordance/reviews/RESEARCH_COMPLETION_AUDIT_v1.11.0.yaml \
