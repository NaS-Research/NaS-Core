...
[`revised_appraisal_progress_v0.4.0.yaml`](revised_appraisal_progress_v0.4.0.yaml):
all 28 lawfully accessible papers are appraised, with 15 `supporting` and 13
`context_only` roles. Two records are access-restricted. The IEEE CC-BY-4.0 author
manuscript was identity-, license-, and checksum-verified and stored immutably.
