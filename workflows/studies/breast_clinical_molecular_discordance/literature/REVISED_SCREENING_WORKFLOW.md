...
[`revised_appraisal_progress_v0.3.5.yaml`](revised_appraisal_progress_v0.3.5.yaml):
15 appraisals are complete, 12 accessible papers are ready for appraisal, two
