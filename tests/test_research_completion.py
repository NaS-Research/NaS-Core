...
AUDIT = STUDY / "reviews" / "RESEARCH_COMPLETION_AUDIT_v1.1.0.yaml"
...
def test_checked_in_completion_audit_proves_current_incomplete_state() -> None:
    ...
    assert (
        validated.phases[1].open_requirements[0]
        == "Founder decision on Phase 1 scientific and statistical planning "
